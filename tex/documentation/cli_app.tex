...
\subsection{exp}\indexCLIcmd{exp}\indexCLIcmd{export}
...
\subsection{sim}\indexCLIcmd{sim}\indexCLIcmd{simulate}\label{d:subsec:sim}
...
\subsection{dbg}\indexCLIcmd{dbg}\indexCLIcmd{debug}
...
\subsection{cfg}\indexCLIcmd{cfg}\indexCLIcmd{config}\label{d:subsec:cfg}
Configure settings.
